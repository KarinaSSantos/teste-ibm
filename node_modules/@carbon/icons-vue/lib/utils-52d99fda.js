  ...
  return _objectSpread2({
    ...
    setup: function setup(_ref, _ref2) {
      ...
      var componentAttrs = _ref2.attrs,
          slots = _ref2.slots;
      return function () {
        return vue.h('svg', getSvgAttrs(title, svgAttrs, componentAttrs), [].concat(_toConsumableArray(title ? [vue.h('title', title)] : []), _toConsumableArray(svgContent.map(function (_ref3) {
          var elem = _ref3.elem,
              attrs = _ref3.attrs;
          return vue.h(elem, attrs);
